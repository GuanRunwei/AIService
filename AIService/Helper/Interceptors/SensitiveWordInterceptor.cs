...
namespace AIService.Helper
{
    ...
    public class SensitiveWordInterceptor
    {
        ...
        {
#if DEBUG
            this.dictionaryPath = Environment.CurrentDirectory + @"\Files\bad.txt";
#else
            this.dictionaryPath = Environment.CurrentDirectory + "\\Files\\bad.txt";
#endif
        }
        ...
        private void LoadDictionary()
        {
            if (DictionaryPath != string.Empty)
            {
                ...
                foreach (string word in words)
                {
                    ...
                    wordList.Add(key);
                    wordList.Add(ChineseConverter.Convert(key, ChineseConversionDirection.SimplifiedToTraditional));
                }
